...
<qgis version="1.8.0-Lisboa" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <aliases>
    <alias field="accessibilite" index="18" name="accessibilité"/>
    ...
    <alias field="ecoulement" index="22" name="écoulement"/>
    <alias field="identif" index="3" name="identifiant"/>
    <alias field="integrite" index="19" name="intégrité"/>
    <alias field="modifie_le" index="28" name="modifié le"/>
    <alias field="proprete" index="20" name="propreté"/>
    <alias field="refdoss" index="1" name="référence dossier"/>
    <alias field="saisie_par" index="29" name="saisie par"/>
    <alias field="securite" index="21" name="sécurité"/>
    <alias field="typ_regard" index="4" name="type de regard"/>
  </aliases>
  <attributeactions>
