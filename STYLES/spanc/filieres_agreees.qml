...
<qgis version="1.8.0-Lisboa" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <aliases>
    ...
    <alias field="cree_le" index="28" name="créé le"/>
    ...
    <alias field="modifie_le" index="29" name="modifié le"/>
    <alias field="proprete" index="18" name="propreté"/>
    <alias field="refdoss" index="1" name="référence dossier"/>
    <alias field="saisie_par" index="30" name="saisie par"/>
  ...
  <attributeactions>
    <actionsetting action="[% &quot;docu2&quot; %]" capture="0" type="5" name="Ouvrir doc constructeur"/>
    <actionsetting action="[% &quot;photo&quot; %]" capture="0" type="5" name="Ouvrir photo"/>
