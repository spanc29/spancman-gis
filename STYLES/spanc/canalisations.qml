...
<qgis version="1.8.0-Lisboa" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 attr="type_eau" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="inconnu" label="inconnu"/>
      <category symbol="1" value="eaux pluviales" label="eaux pluviales"/>
      <category symbol="2" value="eaux usées" label="eaux usées"/>
      <category symbol="3" value="mél. usées-pluviales" label="mélange eaux usées - eaux pluviales"/>
      <category symbol="4" value="épandages" label="épandages"/>
      <category symbol="5" value="drainage" label="drainage (drains agricoles)"/>
      <category symbol="6" value="sous pression" label="sous pression"/>
      <category symbol="7" value="ventilation" label="ventilation"/>
  ...
  <customproperties/>
  <displayfield>materiau</displayfield>
  <label>0</label>
  <labelattributes>
  ...
  <edittypes>
    ...
    <edittype type="5" min="1" step="5" name="diametre" max="500"/>
  ...
  <aliases>
    ...
    <alias field="ecoulement" index="16" name="écoulement"/>
