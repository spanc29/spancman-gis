...
<qgis version="1.8.0-Lisboa" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 attr="type_pompage" symbollevels="0" type="categorizedSymbol">
    <categories>
      ...
      <category symbol="4" value="eaux pluviales" label="eaux pluviales"/>
    </categories>
    <symbols>
  ...
  <aliases>
    ...
    <alias field="cree_le" index="25" name="créé le"/>
    <alias field="desaffecte_le" index="13" name="désaffecté le"/>
    ...
    <alias field="marq_bache" index="5" name="marque"/>
    <alias field="modifie_le" index="26" name="modifié le"/>
    <alias field="proprete" index="18" name="propreté"/>
    <alias field="refdoss" index="1" name="référence dossier"/>
    <alias field="saisie_par" index="27" name="saisie par"/>
    <alias field="securite" index="19" name="sécurité"/>
    <alias field="volume_bache" index="6" name="volume"/>
  </aliases>
  <attributeactions>
