...
<qgis version="1.8.0-Lisboa" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 attr="type_pretr" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="Bac dégraisseur" label="Bac dégraisseur"/>
      <category symbol="1" value="Bac dégraisseur rond" label="Bac dégraisseur rond"/>
      <category symbol="2" value="Bac dégraisseur rectangulaire" label="Bac dégraisseur rectangulaire"/>
      <category symbol="3" value="Fosse septique" label="Fosse septique"/>
      <category symbol="4" value="Fosse septique ronde pas accès" label="Fosse septique ronde pas accès"/>
      <category symbol="5" value="Fosse septique ronde 1 accès" label="Fosse septique ronde 1 accès"/>
      <category symbol="6" value="Fosse Toutes Eaux ronde" label="Fosse Toutes Eaux ronde"/>
      <category symbol="7" value="Fosse Toutes Eaux ronde pas accès" label="Fosse Toutes Eaux ronde pas accès"/>
      <category symbol="8" value="Fosse Toutes Eaux ronde 1 accès" label="Fosse Toutes Eaux ronde 1 accès"/>
      <category symbol="9" value="Fosse Toutes Eaux ronde accès vidange" label="Fosse Toutes Eaux ronde accès vidange"/>
      <category symbol="10" value="Fosse Toutes Eaux ronde accès préfiltre" label="Fosse Toutes Eaux ronde accès préfiltre"/>
      <category symbol="11" value="Fosse Toutes Eaux ronde 2 accès" label="Fosse Toutes Eaux ronde 2 accès"/>
      <category symbol="12" value="Fosse Toutes Eaux rectangulaire" label="Fosse Toutes Eaux rectangulaire"/>
      <category symbol="13" value="Fosse Toutes Eaux rectangulaire pas accès" label="Fosse Toutes Eaux rectangulaire pas accès"/>
      <category symbol="14" value="Fosse Toutes Eaux rectangulaire accès vidange" label="Fosse Toutes Eaux rectangulaire accès vidange"/>
      <category symbol="15" value="Fosse Toutes Eaux rectangulaire accès préfiltre" label="Fosse Toutes Eaux rectangulaire accès préfiltre"/>
      <category symbol="16" value="Fosse Toutes Eaux rectangulaire 2 accès" label="Fosse Toutes Eaux rectangulaire 2 accès"/>
      <category symbol="17" value="Préfiltre à pouzzolane rond" label="Préfiltre à pouzzolane rond"/>
      <category symbol="18" value="Filtre bactérien rond" label="Filtre bactérien rond"/>
      <category symbol="19" value="Filtre bactérien rectangulaire" label="Filtre bactérien rectangulaire"/>
      <category symbol="20" value="Filtre à cheminement lent" label="Filtre à cheminement lent"/>
      <category symbol="21" value="épurateur rond" label="épurateur rond"/>
      <category symbol="22" value="épurateur rectangulaire" label="épurateur rectangulaire"/>
      <category symbol="23" value="Inconnu" label="Inconnu"/>
      <category symbol="24" value="Inconnu rond" label="Inconnu rond"/>
      <category symbol="25" value="Inconnu rectangulaire" label="Inconnu rectangulaire"/>
      <category symbol="26" value="Inconnu oblong" label="Inconnu oblong"/>
    </categories>
    <symbols>
      <symbol outputUnit="MapUnit" alpha="1" type="marker" name="0">
        <layer pass="0" class="SvgMarker" locked="0">
          ...
          <prop k="name" v="/pretraitements/bac_deg_rect.svg"/>
          <prop k="offset" v="0,0"/>
      ...
      <symbol outputUnit="MapUnit" alpha="1" type="marker" name="1">
        <layer pass="0" class="SvgMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="fill" v="#000000"/>
          <prop k="name" v="/pretraitements/bac_degrais_rond1.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="outline" v="#000000"/>
          <prop k="outline-width" v="1"/>
          <prop k="size" v="2"/>
      ...
      <symbol outputUnit="MapUnit" alpha="1" type="marker" name="10">
        <layer pass="0" class="SvgMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="fill" v="#000000"/>
          <prop k="name" v="/pretraitements/fte_ronde_1a_ouest.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="outline" v="#000000"/>
          <prop k="outline-width" v="1"/>
          <prop k="size" v="2"/>
      ...
      <symbol outputUnit="MapUnit" alpha="1" type="marker" name="11">
        <layer pass="0" class="SvgMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="fill" v="#000000"/>
          <prop k="name" v="/pretraitements/fte_ronde_2a.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="outline" v="#000000"/>
          <prop k="outline-width" v="1"/>
          <prop k="size" v="2"/>
      ...
      <symbol outputUnit="MapUnit" alpha="1" type="marker" name="12">
        <layer pass="0" class="SvgMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="fill" v="#000000"/>
          <prop k="name" v="/pretraitements/fte_rect.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="outline" v="#000000"/>
          <prop k="outline-width" v="1"/>
          <prop k="size" v="3"/>
      ...
      <symbol outputUnit="MapUnit" alpha="1" type="marker" name="14">
        <layer pass="0" class="SvgMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="fill" v="#000000"/>
          <prop k="name" v="/pretraitements/fte_rect_1a.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="outline" v="#000000"/>
          <prop k="outline-width" v="1"/>
          <prop k="size" v="3"/>
      ...
      <symbol outputUnit="MapUnit" alpha="1" type="marker" name="15">
        <layer pass="0" class="SvgMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="fill" v="#000000"/>
          <prop k="name" v="/pretraitements/fte_rect_1a_pf.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="outline" v="#000000"/>
          <prop k="outline-width" v="1"/>
          <prop k="size" v="3"/>
      ...
      <symbol outputUnit="MapUnit" alpha="1" type="marker" name="16">
        <layer pass="0" class="SvgMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="fill" v="#000000"/>
          <prop k="name" v="/pretraitements/fte_rect_2a.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="outline" v="#000000"/>
          <prop k="outline-width" v="1"/>
          <prop k="size" v="3"/>
      ...
      <symbol outputUnit="MapUnit" alpha="1" type="marker" name="17">
        <layer pass="0" class="SvgMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="fill" v="#000000"/>
          <prop k="name" v="/pretraitements/prefiltre_rond1.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="outline" v="#000000"/>
          <prop k="outline-width" v="1"/>
          <prop k="size" v="2"/>
      ...
      <symbol outputUnit="MapUnit" alpha="1" type="marker" name="18">
        <layer pass="0" class="SvgMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="fill" v="#000000"/>
          <prop k="name" v="/pretraitements/filtre_bacterien_rond1.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="outline" v="#000000"/>
          <prop k="outline-width" v="1"/>
          <prop k="size" v="2"/>
      ...
      <symbol outputUnit="MapUnit" alpha="1" type="marker" name="19">
        <layer pass="0" class="SvgMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="fill" v="#000000"/>
          <prop k="name" v="/pretraitements/filtre_bacterien_rect1.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="outline" v="#000000"/>
          <prop k="outline-width" v="1"/>
          <prop k="size" v="2"/>
      ...
      <symbol outputUnit="MapUnit" alpha="1" type="marker" name="2">
        <layer pass="0" class="SvgMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="fill" v="#000000"/>
          <prop k="name" v="/pretraitements/bac_deg_rect1.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="outline" v="#000000"/>
          <prop k="outline-width" v="1"/>
          <prop k="size" v="2"/>
      ...
      <symbol outputUnit="MapUnit" alpha="1" type="marker" name="20">
        <layer pass="0" class="SvgMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="fill" v="#000000"/>
          <prop k="name" v="/pretraitements/epurateur_rect.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="outline" v="#000000"/>
          <prop k="outline-width" v="1"/>
          <prop k="size" v="2"/>
      ...
      <symbol outputUnit="MapUnit" alpha="1" type="marker" name="21">
        <layer pass="0" class="SvgMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="fill" v="#000000"/>
          <prop k="name" v="/pretraitements/epurateur_rond.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="outline" v="#000000"/>
          <prop k="outline-width" v="1"/>
          <prop k="size" v="2"/>
      ...
      <symbol outputUnit="MapUnit" alpha="1" type="marker" name="23">
        <layer pass="0" class="SvgMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="fill" v="#000000"/>
          <prop k="name" v="/pretraitements/forme_rectang.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="outline" v="#000000"/>
          <prop k="outline-width" v="1"/>
          <prop k="size" v="3"/>
      ...
      <symbol outputUnit="MapUnit" alpha="1" type="marker" name="24">
        <layer pass="0" class="SvgMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="fill" v="#000000"/>
          <prop k="name" v="/pretraitements/forme_ronde.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="outline" v="#000000"/>
          <prop k="outline-width" v="1"/>
          <prop k="size" v="3"/>
      ...
      <symbol outputUnit="MapUnit" alpha="1" type="marker" name="26">
        <layer pass="0" class="SvgMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="fill" v="#000000"/>
          <prop k="name" v="/pretraitements/forme_oblongue.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="outline" v="#000000"/>
          <prop k="outline-width" v="1"/>
          <prop k="size" v="3"/>
      ...
      <symbol outputUnit="MapUnit" alpha="1" type="marker" name="3">
        <layer pass="0" class="SvgMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="fill" v="#000000"/>
          <prop k="name" v="/pretraitements/fs_cloison.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="outline" v="#000000"/>
          <prop k="outline-width" v="1"/>
          <prop k="size" v="2"/>
      ...
      <symbol outputUnit="MapUnit" alpha="1" type="marker" name="4">
        <layer pass="0" class="SvgMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="fill" v="#000000"/>
          <prop k="name" v="/pretraitements/fs.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="outline" v="#000000"/>
          <prop k="outline-width" v="1"/>
          <prop k="size" v="2"/>
      ...
      <symbol outputUnit="MapUnit" alpha="1" type="marker" name="5">
        <layer pass="0" class="SvgMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="fill" v="#000000"/>
          <prop k="name" v="/pretraitements/fs_1a.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="outline" v="#000000"/>
          <prop k="outline-width" v="1"/>
          <prop k="size" v="2"/>
      ...
      <symbol outputUnit="MapUnit" alpha="1" type="marker" name="6">
        <layer pass="0" class="SvgMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="fill" v="#000000"/>
          <prop k="name" v="/pretraitements/fte_ronde.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="outline" v="#000000"/>
          <prop k="outline-width" v="1"/>
          <prop k="size" v="2"/>
      ...
      <symbol outputUnit="MapUnit" alpha="1" type="marker" name="8">
        <layer pass="0" class="SvgMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="fill" v="#000000"/>
          <prop k="name" v="/pretraitements/fte_ronde_1a_central.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="outline" v="#000000"/>
          <prop k="outline-width" v="1"/>
          <prop k="size" v="2"/>
      ...
      <symbol outputUnit="MapUnit" alpha="1" type="marker" name="9">
        <layer pass="0" class="SvgMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="fill" v="#000000"/>
          <prop k="name" v="/pretraitements/fte_ronde_1a_est.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="outline" v="#000000"/>
          <prop k="outline-width" v="1"/>
          <prop k="size" v="2"/>
  ...
  <edittypes>
    ...
    <edittype type="5" min="0" step="1" name="nb_acces" max="10"/>
    ...
    <edittype type="0" name="sortie"/>
    <edittype type="5" min="1" step="1" name="taille" max="100"/>
    <edittype type="3" name="type_pretr">
      <valuepair key="Bac dégraisseur" value="Bac dégraisseur"/>
      <valuepair key="Bac dégraisseur rectangulaire" value="Bac dégraisseur rectangulaire"/>
      <valuepair key="Bac dégraisseur rond" value="Bac dégraisseur rond"/>
      <valuepair key="Filtre bactérien" value="Filtre bactérien"/>
      <valuepair key="Filtre bactérien rectangulaire" value="Filtre bactérien rectangulaire"/>
      <valuepair key="Filtre bactérien rond" value="Filtre bactérien rond"/>
      <valuepair key="Filtre à cheminement lent" value="Filtre à cheminement lent"/>
      <valuepair key="Fosse Toutes Eaux" value="Fosse Toutes Eaux"/>
      <valuepair key="Fosse Toutes Eaux rectangulaire" value="Fosse Toutes Eaux rectangulaire"/>
      <valuepair key="Fosse Toutes Eaux rectangulaire 2 accès" value="Fosse Toutes Eaux rectangulaire 2 accès"/>
      <valuepair key="Fosse Toutes Eaux rectangulaire accès préfiltre" value="Fosse Toutes Eaux rectangulaire accès préfiltre"/>
      <valuepair key="Fosse Toutes Eaux rectangulaire accès vidange" value="Fosse Toutes Eaux rectangulaire accès vidange"/>
      <valuepair key="Fosse Toutes Eaux rectangulaire pas accès" value="Fosse Toutes Eaux rectangulaire pas accès"/>
      <valuepair key="Fosse Toutes Eaux ronde" value="Fosse Toutes Eaux ronde"/>
      <valuepair key="Fosse Toutes Eaux ronde 1 accès" value="Fosse Toutes Eaux ronde 1 accès"/>
      <valuepair key="Fosse Toutes Eaux ronde 2 accès" value="Fosse Toutes Eaux ronde 2 accès"/>
      <valuepair key="Fosse Toutes Eaux ronde accès préfiltre" value="Fosse Toutes Eaux ronde accès préfiltre"/>
      <valuepair key="Fosse Toutes Eaux ronde accès vidange" value="Fosse Toutes Eaux ronde accès vidange"/>
      <valuepair key="Fosse Toutes Eaux ronde pas accès" value="Fosse Toutes Eaux ronde pas accès"/>
      <valuepair key="Fosse septique" value="Fosse septique"/>
      <valuepair key="Fosse septique ronde" value="Fosse septique ronde"/>
      <valuepair key="Fosse septique ronde 1 accès" value="Fosse septique ronde 1 accès"/>
      <valuepair key="Fosse septique ronde pas accès" value="Fosse septique ronde pas accès"/>
      <valuepair key="Inconnu" value="Inconnu"/>
      <valuepair key="Inconnu oblong" value="Inconnu oblong"/>
      <valuepair key="Inconnu rectangulaire" value="Inconnu rectangulaire"/>
      <valuepair key="Inconnu rond" value="Inconnu rond"/>
      <valuepair key="Préfiltre à pouzzolane rond" value="Préfiltre à pouzzolane rond"/>
      <valuepair key="épurateur rectangulaire" value="épurateur rectangulaire"/>
      <valuepair key="épurateur rond" value="épurateur rond"/>
    </edittype>
  ...
  <aliases>
    ...
    <alias field="modifie_le" index="28" name="modifié le"/>
    <alias field="proprete" index="17" name="propreté"/>
    <alias field="refdoss" index="1" name="référence dossier"/>
    <alias field="saisie_par" index="29" name="saisie par"/>
