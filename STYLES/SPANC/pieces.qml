...
<qgis version="1.8.0-Lisboa" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 attr="piece" symbollevels="0" type="categorizedSymbol">
    <categories>
  ...
  <edittypes>
    ...
    <edittype type="3" name="piece">
      <valuepair key="WC" value="WC"/>
      <valuepair key="annexe" value="annexe"/>
      <valuepair key="buanderie" value="buanderie"/>
      <valuepair key="bureau" value="bureau"/>
      <valuepair key="cellier" value="cellier"/>
      <valuepair key="chambre" value="chambre"/>
      <valuepair key="cuisine" value="cuisine"/>
      <valuepair key="divers" value="divers"/>
      <valuepair key="garage" value="garage"/>
      <valuepair key="grenier" value="grenier"/>
      <valuepair key="mezzanine" value="mezzanine"/>
      <valuepair key="pièce de service" value="pièce de service"/>
      <valuepair key="pièce principale" value="pièce principale"/>
      <valuepair key="salle d'eau" value="salle d'eau"/>
      <valuepair key="salle de bains" value="salle de bains"/>
      <valuepair key="salle de jeux" value="salle de jeux"/>
      <valuepair key="salon" value="salon"/>
      <valuepair key="salon-séjour" value="salon-séjour"/>
      <valuepair key="séjour" value="séjour"/>
    </edittype>
  ...
  <aliases>
    ...
    <alias field="est_pp" index="6" name="pp?"/>
  </aliases>
  <attributeactions/>
