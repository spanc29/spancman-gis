...
<qgis version="1.8.0-Lisboa" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 attr="type_surface" symbollevels="0" type="categorizedSymbol">
    <categories>
      ...
      <category symbol="2" value="autre" label="autre"/>
      <category symbol="3" value="construction" label="construction"/>
      <category symbol="4" value="imperméable" label="imperméable"/>
      <category symbol="5" value="inapte ANC" label="inapte ANC"/>
      <category symbol="6" value="Jardin/plantations" label="Jardin/plantations"/>
      <category symbol="7" value="parking" label="parking"/>
      <category symbol="8" value="stationnement léger" label="stationnement léger"/>
      <category symbol="9" value="stationnement lourd" label="stationnement lourd"/>
      <category symbol="10" value="stockage" label="stockage"/>
      <category symbol="11" value="terrasse" label="terrasse"/>
      <category symbol="12" value="" label=""/>
      <category symbol="13" value="circulation lourde" label="circulation lourde"/>
      <category symbol="14" value="circulation légére" label="circulation légére"/>
      <category symbol="15" value="piscine" label="piscine"/>
  ...
  <labelattributes>
    ...
    <color fieldname="" red="80" blue="80" green="80"/>
    <x fieldname=""/>
    <y fieldname=""/>
  ...
  <edittypes>
    <edittype type="0" name="ACCESSIBLE"/>
    ...
    <edittype type="0" name="SECURITE"/>
    <edittype type="3" name="TYP_SURFAC">
      <valuepair key="Jardin/plantations" value="Jardin/plantations"/>
      <valuepair key="aire piéton" value="aire piéton"/>
      <valuepair key="autre" value="autre"/>
      <valuepair key="circulation lourde" value="circulation lourde"/>
      <valuepair key="circulation légére" value="circulation légére"/>
      <valuepair key="construction" value="construction"/>
      <valuepair key="imperméable" value="imperméable"/>
      <valuepair key="inapte ANC" value="inapte ANC"/>
      <valuepair key="mare/plan d'eau" value="mare/plan d'eau"/>
      <valuepair key="parking" value="parking"/>
      <valuepair key="piscine" value="piscine"/>
      <valuepair key="stationnement lourd" value="stationnement lourd"/>
      <valuepair key="stationnement léger" value="stationnement léger"/>
      <valuepair key="stockage" value="stockage"/>
      <valuepair key="terrasse" value="terrasse"/>
