...
<qgis version="1.8.0-Lisboa" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <edittypes>
    ...
    <edittype allowNull="false" orderByValue="true" key="refdoss" layer="dossiers20120603150709927" type="15" value="refdoss" name="refdoss"/>
    <edittype type="0" name="saisie_par"/>
    <edittype type="3" name="type_installations">
      <valuepair key="archivée" value="archivée"/>
      <valuepair key="existante" value="existante"/>
      <valuepair key="ghost" value="ghost"/>
      <valuepair key="projet" value="projet"/>
    </edittype>
  </edittypes>
  <editform>.</editform>
  ...
  <aliases>
    <alias field="cree_le" index="5" name="créée le"/>
    <alias field="identif" index="2" name="identifiant"/>
    <alias field="modifie_le" index="6" name="modifiée le"/>
    <alias field="refdoss" index="1" name="référence dossier"/>
    <alias field="saisie_par" index="7" name="saisie par"/>
  </aliases>
  <attributeactions>
    <actionsetting action="QtGui.QMessageBox.information(None, &quot;clé GID&quot;, &quot;la clé gid est [% $id %]&quot;)" capture="0" type="1" name="Récupère l'id de l'entité"/>
  </attributeactions>
