...
<qgis version="1.8.0-Lisboa" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <edittypes>
    ...
    <edittype type="5" min="1800" step="10" name="annee_pose" max="2100"/>
  ...
  <aliases>
    ...
    <alias field="cree_le" index="11" name="créé le"/>
    <alias field="identif" index="2" name="identifiant"/>
    <alias field="modifie_le" index="12" name="modifié le"/>
    <alias field="refdoss" index="1" name="référence dossier"/>
    <alias field="saisie_par" index="13" name="saisie par"/>
  </aliases>
  <attributeactions>
